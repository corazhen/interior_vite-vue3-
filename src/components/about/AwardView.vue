  ...
  <section id="award">
    <div id="award-inner">
      ...
      <div class="award-contain">
        ...
        <div class="award-f-t">
          <a class="award-f-txt"> 德國 IF DESIGN AWARD </a>
          <a class="award-f-txt">
            台灣 TID Awards<br />
            單層住宅類 大獎
          </a>
          <a class="award-f-txt"> 英國 LICC 建築榮譽獎 </a>
        </div>
        <div class="award-f">
          <a class="award-f-c">
        ...
        <div class="award-f-t">
          <a class="award-f-txt"> 韓國 K DESIGN AWARD 大獎 </a>
          <a class="award-f-txt"> 台灣 TID Awards<br />居住空間類 大獎 </a>
          <a class="award-f-txt"> 新加坡 SIDA 大獎 </a>
        </div>
      </div>
      <div class="page-btn">
